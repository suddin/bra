package ca.hhyxe14.webapp.action;
...
import ca.hhyxe14.webapp.util.RequestUtil;
...
public class UserAction extends BaseAction implements Preparable {
    ...
    public String view() throws IOException {
        ...
        if (id != null) {
        	...
        	patient = patientManager.getPatient(Long.parseLong(id));
        	
        	 if(patient == null){
             	saveMessage("No match found...");
             	return "no_match";
        	 }
